## raw_connected_v1 Grid Travel Time

This folder builds grid-to-grid AM travel time directly from the
`raw_connected_v1`
directed road network without modifying any files under
`data_work/src/raw_connected_v1/Processed_Data/`.

### Inputs

- `data_work/src/raw_connected_v1/Processed_Data/directed_edges.xlsx`
- `data_work/src/raw_connected_v1/Processed_Data/nodes.xlsx`
...
1. Use the `raw_connected_v1` directed road graph as the routing network.
...
- `data_work/outputs/raw_connected_v1_grid_travel_time_v1/data`
- `data_work/outputs/raw_connected_v1_grid_travel_time_v1/metrics`

### Example

```bash
python -m src.raw_connected_v1.grid_travel_time.build_raw_connected_v1_grid_travel_time
```
