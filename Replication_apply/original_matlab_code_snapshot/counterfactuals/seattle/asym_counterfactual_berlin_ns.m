...
%% Berlin Wall Parameters, no spillovers
theta = 6.83;
...
parfor i = 1:m
    ...
    chi_lr_lf_export_name = strcat('chi_lr_lf_ber_ns_', num2str(index(1)), '_', num2str(index(2)), '.csv');
    traffic_export_name = strcat('traffic_ber_ns_', num2str(index(1)), '_', num2str(index(2)), '.csv');
    t_hat_export_name = strcat('t_hat_ber_ns_', num2str(index(1)), '_', num2str(index(2)), '.csv');
    err_export_name = strcat('err_ber_ns_', num2str(index(1)), '_', num2str(index(2)), '.csv');
